//package com.example.udemy_pagingapp.adapter;
//
...
//import com.example.udemy_pagingapp.databinding.SingleMovieItemBinding;
...
//
//    public MoviesAdapter(@NonNull DiffUtil.ItemCallback<Movie> diffCallback, @NonNull CoroutineContext mainDispatcher, @NonNull CoroutineContext workerDispatcher, RequestManager glide) {
//
//        super(diffCallback);
//        this.glide = glide;
//    }
...
//            holder.movieItemBinding.ratingMovieTxt.setText(String.valueOf(currentMovie.getVoteAverage()));
//
//        }
//
//    }
...
public class MoviesAdapter extends PagingDataAdapter<Movie, MoviesAdapter.MovieViewHolder> {
    ...
    @Override
    public int getItemViewType(int position) {
        return (getItem(position) == null) ? LOADING_ITEM : MOVIE_ITEM;
    }
