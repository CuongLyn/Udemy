...
import com.example.udemy_contactsmanagerapp.databinding.ContactListItemBinding;
...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ContactViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ContactViewHolder holder, int position) {
        //Called by RecyclerView when it need to display or update an item
    ...
    public int getItemCount() {
        //Determines the total number of items in the dataset that
        //will displayed in the recyclerView
